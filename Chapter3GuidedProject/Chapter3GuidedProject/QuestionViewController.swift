...
class QuestionViewController: UIViewController {
  ...
  var questions: [Question] = [
    Question(
      ...
      type:.single,
      answers: [
        Answer(text: "Steak", type: .beef),
        Answer(text: "Fish", type: .pork),
        Answer(text: "Carrots", type: .chiken),
        Answer(text: "Corn", type: .horse)
      ]
    ),
    Question(
      ...
      type: .multiple,
      answers: [
        Answer(text: "Swimming", type: .horse),
        Answer(text: "Sleeping", type: .pork),
        Answer(text: "Cuddling", type: .chiken),
        Answer(text: "Eating", type: .beef)
      ]
    ),
    Question(
      ...
      type: .ranged,
      answers: [
        Answer(text: "I dislike them", type: .pork),
        Answer(text: "I get a little nervous", type: .chiken),
        Answer(text: "I barely notice them", type: .horse),
        Answer(text: "I love them", type: .beef)
      ]
    )
  ]
  ...
  @IBAction func multipleAnswerPressed(_ sender: UIButton) {
    let currentAnswers = questions[questionIndex].answers
    if multipleSwitch1.isOn { answersChosen.append(currentAnswers[0]) }
    if multipleSwitch2.isOn { answersChosen.append(currentAnswers[1]) }
    if multipleSwitch3.isOn { answersChosen.append(currentAnswers[2]) }
    if multipleSwitch4.isOn { answersChosen.append(currentAnswers[3]) }
    nextQuestion()
  }
