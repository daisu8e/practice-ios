...
class AddTodoView: UIView {
  ...
  private func createNavigationBar() -> UINavigationBar {
    ...
    navigationItem.leftBarButtonItem = UIBarButtonItem(barButtonSystemItem: .cancel, target: ctrl, action: #selector(AddTodoViewController.handleCancelButton))
    navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .done, target: ctrl, action: #selector(AddTodoViewController.handleDoneButton))
